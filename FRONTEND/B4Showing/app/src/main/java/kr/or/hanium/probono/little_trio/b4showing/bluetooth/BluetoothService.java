...
public class BluetoothService {
    ...
    public void enableBluetooth(){
        ...
        if(btAdapter.isEnabled()){
            ...
            btActivity.startActivityForResult(i,REQUEST_ENABLE_BT);        }
    }

    public void scanDevice(){
        Log.d(TAG, "Scan Device");

        Intent serverIntent = new Intent(btActivity, DeviceListActivity.class);
        btActivity.startActivityForResult(serverIntent, REQUEST_CONNECT_DEVICE);
    }
    ...
    private synchronized void setState(int state) {
        ...
        mState = state;
       // btHandler.obtainMessage(BluetoothConnection.MESSAGE_STATE_CHANGE,state,-1).sendToTarget();
    }
